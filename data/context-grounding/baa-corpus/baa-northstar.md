# Business Associate Agreement — Northstar Regional Health

**Agreement ID:** baa-northstar · **Version:** version 2024.03 · **Governing law:** State of TN

This Business Associate Agreement ("BAA") is entered into between **Northstar Regional Health**
("Covered Entity", a integrated delivery network operating 7 hospital facility(ies))
...
ClearFlow indemnifies provider for vector-attributable breach.
...
Fabric record `baa-northstar` exactly; not legal advice; no real entities.*
