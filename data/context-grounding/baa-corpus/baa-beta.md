# Business Associate Agreement — Beta Community Hospital

**Agreement ID:** baa-beta · **Version:** version 2024.06 · **Governing law:** State of DE

This Business Associate Agreement ("BAA") is entered into between **Beta Community Hospital**
("Covered Entity", a rural operating 1 hospital facility(ies))
...
Security Incident materially affecting claim flow integrity, **within 48 hours** of
...
Provider waives consequential damages.
...
Fabric record `baa-beta` exactly; not legal advice; no real entities.*
