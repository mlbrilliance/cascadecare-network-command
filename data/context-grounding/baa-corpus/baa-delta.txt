# Business Associate Agreement — Delta Surgical Institute

**Agreement ID:** baa-delta · **Version:** version 2023.09 · **Governing law:** State of NY

This Business Associate Agreement ("BAA") is entered into between **Delta Surgical Institute**
("Covered Entity", a specialty surgical operating 1 hospital facility(ies))
...
Security Incident materially affecting claim flow integrity, **within 72 hours** of
...
Business Associate shall complete a pre-disclosure consultation with Covered Entity's designated privacy officer and shall NOT notify any third party, including regulators, before joint forensic review concludes, except where disclosure is compelled by law.
...
Mutual indemnification, no cap for willful misconduct.
...
Fabric record `baa-delta` exactly; not legal advice; no real entities.*
