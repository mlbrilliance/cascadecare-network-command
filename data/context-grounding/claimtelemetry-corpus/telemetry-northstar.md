# Claim-Flow Telemetry Summary — Northstar Regional Health

Synthetic 30-day hourly claim telemetry (window starting 2026-01-01T00:00:00Z, 720 hourly
buckets) for provider `northstar` on the ClearFlow Payment Network.

## Baseline (Day 0, pre-incident)

- Monthly claim volume: ~480,000 claims; baseline throughput ~666 claims/hour.
- Intraday pattern: business hours (08:00-18:00) run at 1.4x the base rate; nights at 0.6x.
- Day-0 total: 15,439 claims. Anomaly score steady at 0.12; anomaly flag false.
...
- Suppressed daily throughput: ~5,393 claims/day.
...
deterministic `ClaimTelemetry` Data Fabric records for `northstar` exactly; no real claim data.*
