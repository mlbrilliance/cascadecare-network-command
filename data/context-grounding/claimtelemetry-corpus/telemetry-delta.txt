# Claim-Flow Telemetry Summary — Delta Surgical Institute

Synthetic 30-day hourly claim telemetry (window starting 2026-01-01T00:00:00Z, 720 hourly
buckets) for provider `delta` on the ClearFlow Payment Network.

## Baseline (Day 0, pre-incident)

- Monthly claim volume: ~24,000 claims; baseline throughput ~33 claims/hour.
- Intraday pattern: business hours (08:00-18:00) run at 1.4x the base rate; nights at 0.6x.
- Day-0 total: 753 claims. Anomaly score steady at 0.12; anomaly flag false.
...
- Suppressed daily throughput: ~254 claims/day.
...
deterministic `ClaimTelemetry` Data Fabric records for `delta` exactly; no real claim data.*
